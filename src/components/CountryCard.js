...
CountryCard.propTypes = {
  country: PropTypes.shape({
    cca2: PropTypes.string.isRequired,      // 2-digit country code
    region: PropTypes.string.isRequired,    //  the country region e.g Africa
    name: PropTypes.shape({
      common: PropTypes.string.isRequired   // the common name of the country e.g Nigeria
    }).isRequired
  }).isRequired
}
